...
<header>
    ...
    <nav class="gnav">
        <a href="index.php"><img src="cafe/img/logo.png" alt="カフェロゴ"></a>
        <ul id="page-link01">
            <li><a href="index.php#area-1" class="hoverlink">はじめに</a></li>
            <li><a href="index.php#area-2" class="hoverlink">体験</a></li>
